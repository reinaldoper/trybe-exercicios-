import pytest
from codigo import is_odd, divide, fizzbuzz, get_most_ordered_dish_per_costumer
...
# def
# test_get_order_frequency_per_costumer_when_customer_is_joao_and_order_is_pizza(orders):
#    assert get_order_frequency_per_costumer(orders, "joao", "pizza") == 0


# def test_get_order_frequency_per_costumer
# _when_customer_is_maria_and_order_is_hamburger(orders):
